...
constexpr auto qt_meta_stringdata_CLASSDisplayENDCLASS = QtMocHelpers::stringData(
    "Display",
    "ReadingData",
    "",
    "SendingAnswer",
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SendingAnswer((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
